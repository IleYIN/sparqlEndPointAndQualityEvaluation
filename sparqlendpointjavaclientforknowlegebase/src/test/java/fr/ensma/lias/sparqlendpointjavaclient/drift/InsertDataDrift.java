...
public class InsertDataDrift {
	
	public static void main(String[] args) throws MalformedURLException, ProtocolException, IOException {
		
//		String urladdress1 = "http://193.55.163.212:8214/lgeodata2014/sparql";
//		String command1 = "SELECT (count( ?subject) as ?n) ?predicate WHERE {?subject a lgdo:Restaurant.   ?subject ?predicate ?object } group by ?predicate order by desc(?n)";
//		String resultfilename1 = "resultFileDrift1.txt";
//		
//		String urladdress2 = "http://193.55.163.212:8215/lgeodata2015/sparql";
//		String command2 = "SELECT (count( ?subject) as ?n) ?predicate WHERE {?subject a lgdo:Restaurant.   ?subject ?predicate ?object } group by ?predicate order by desc(?n)";
//		String resultfilename2 = "resultFileDrift2.txt";
//		
...
//		requete(urladdress2, command2, resultfilename2);
		...
		insertData("resultFileDrift1.txt", list1);	
		
		List<DataDrift> list2 = new ArrayList<DataDrift>();
		insertData("resultFileDrift2.txt", list2);	
		
		
		
		PrintWriter pwDiff = new PrintWriter(new FileWriter("resultFileDiffDrift.txt"));
